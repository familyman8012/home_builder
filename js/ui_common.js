...
$(document).on('click', '.set_list_depth1 .btn_add', function () {
    if ($(this).closest('li').find('.list_depth2').length == 0) {
        $(this).closest('li').append('<ul class="list_depth2 nested-sortable"></ul>');
    }
...
function componentAdd(sel_section_idx, clickComponentAdd) {
    ...
    $(document).on('click', '.pop_component_add li', function (e) {
        ...
        if ($('.add_section_pop').hasClass('top')) {
            $('main section').eq(sectionIdx).before('<section  data-include="include/component.html .comp' + btnIdx + '"></section>');
        } else if ($('.add_section_pop').hasClass('bottom')) {
            $('main section').eq(sectionIdx).after('<section  data-include="include/component.html .comp' + btnIdx + '"></section>');
        }
        includeLayout2();
    ...
    $(document).on('click', '.visual_dsgn li', function (e) {
        ...
        var btnIdx = $(this).index();
        if ($('.add_section_pop').hasClass('top')) {
            $('main section').eq(sectionIdx).before('<section  data-include="include/component.html .mainvisual' + btnIdx + '"></section>');
        } else if ($('.add_section_pop').hasClass('bottom')) {
            $('main section').eq(sectionIdx).after('<section  data-include="include/component.html .mainvisual' + btnIdx + '"></section>');
        }
    ...
    $(document).on('click', '.wrap_dsgn_list dl', function (e) {
        ...
        if ($(this).index() != 4) {
            if ($('.add_section_pop').hasClass('top')) {
                $('main section').eq(sectionIdx).before('<section  data-include="include/component.html .designEl' + btnIdx + '"></section>');
            } else if ($('.add_section_pop').hasClass('bottom')) {
                $('main section').eq(sectionIdx).after('<section  data-include="include/component.html .designEl' + btnIdx + '"></section>');
            }

        } else {
            if ($('.add_section_pop').hasClass('top')) {
                $('main section').eq(sectionIdx).prepend('<div  data-include="include/component.html .designEl' + btnIdx + '"></div>');
            } else if ($('.add_section_pop').hasClass('bottom')) {
                $('main section').eq(sectionIdx).append('<div  data-include="include/component.html .designEl' + btnIdx + '"></div>');
            }
        }
